...
/**
 * 通过系统属性来适应屏幕的横屏和竖屏，然后确定画横的，
 * 还是竖的Divider，其实在里面我们做了三件事，第一件是：获取到系统中的listDivider，
 * 我们就是通过它在主题中去设置的，下面第（6）小点看一下代码就知道了。第二件事：
 * 就是找到我们需要添加Divider的位置，从onDraw方法中去找到，并将Divider添加进去。
 * 第三个是：得到Item的偏移量。
 */
